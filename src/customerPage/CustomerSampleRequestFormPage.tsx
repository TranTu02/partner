                    ...
                    <div className="hidden lg:flex w-[480px] flex-col bg-white border-r border-border h-full overflow-hidden shrink-0 shadow-sm">
                        ...
                        <div className="flex-1 overflow-y-auto p-5 scroll-smooth space-y-6">
                            ...
                            <div className="bg-card rounded-lg border border-border p-4 shadow-sm relative pt-5">
                                <div className="absolute top-0 left-0 bg-blue-100 text-blue-700 px-2 py-0.5 rounded-br-lg text-[10px] font-bold uppercase tracking-wider">Thông tin cơ bản</div>
                                <div className="space-y-3 mt-1">
                                    <div className="grid grid-cols-2 gap-3">
                                        <div className="col-span-2 sm:col-span-1">
                                            ...
                                            <input
                                                type="text"
                                                className="w-full px-2 py-1.5 border border-border rounded focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary bg-input text-foreground text-xs"
                            ...
                            <div className="bg-card rounded-lg border border-border p-4 shadow-sm relative pt-5">
                                <div className="absolute top-0 left-0 bg-green-100 text-green-700 px-2 py-0.5 rounded-br-lg text-[10px] font-bold uppercase tracking-wider">Thông tin liên hệ</div>
                                <div className="space-y-3 mt-1">
                                    <div className="grid grid-cols-2 gap-3">
                                        <div>
                            ...
                            <div className="bg-card rounded-lg border border-border p-4 shadow-sm relative pt-5">
                                <div className="absolute top-0 left-0 bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded-br-lg text-[10px] font-bold uppercase tracking-wider">Người nhận báo cáo</div>
                                <div className="space-y-3 mt-1">
                                    <div className="grid grid-cols-2 gap-3">
                                        <div>
                            ...
                            <div className="bg-card rounded-lg border border-border p-4 shadow-sm relative pt-5">
                                <div className="absolute top-0 left-0 bg-purple-100 text-purple-700 px-2 py-0.5 rounded-br-lg text-[10px] font-bold uppercase tracking-wider">Thông tin hóa đơn</div>
                                <div className="space-y-3 mt-1">
                                    <div>
                            ...
                            {data.samples.map((sample, sampleIdx) => (
                                <div key={sampleIdx} className="bg-card rounded-lg border border-border p-4 shadow-sm relative pt-5">
                                    ...
                                    <div className="space-y-4">
                                        <div className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Danh sách chỉ tiêu ({sample.analyses?.length || 0})</div>
                                            ...
                                            <div key={analysisIdx} className="p-3 bg-muted/30 rounded-md border border-border/50">
                                                <div className="flex gap-3 items-end">
                                                    <div className="flex-1">
                                                        <label className="block mb-1 text-[11px] font-medium text-muted-foreground">Chỉ tiêu</label>
                                                        <input
                                                            value={analysis.parameterName}
                                                            disabled
                                                            className="w-full px-2 py-1 border border-border rounded bg-gray-100 text-foreground text-xs truncate"
                                                        />
                                                    </div>
                                                    <div className="w-[120px]">
                                                        <label className="block mb-1 text-[11px] font-medium text-muted-foreground">{t("table.method", "Phương pháp")}</label>
                                                        <input
                                                            type="text"
                                                    ...
                                                    <div className="w-[80px]">
                                                        <label className="block mb-1 text-[11px] font-medium text-muted-foreground">{t("order.print.unit", "Đơn vị")}</label>
                                                        <input
                                                            type="text"
                                                            className="w-full px-2 py-1 border border-border rounded focus:border-primary focus:outline-none bg-white text-xs"
