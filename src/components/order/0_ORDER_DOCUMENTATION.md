...
**Purpose**: Displays the list of orders with advanced filtering and management capabilities.

**Columns**:

- **Order Code**: Displays Order ID and Created Date. Filterable by Created Date range.
- **Client**: Client Name and Tax Code.
- **Total**: Total order amount.
- **Reception Info**: Displays Receipt ID and Request Date. Filterable by Receipt ID status (Received/Not Received) and Request Date range.
- **Status**: Order Status and Payment Status badges.
- **Actions**: View details, Edit note.

**Features**:

- **Advanced Filtering**: Integrated column filters for dates, statuses, and receipt info.
- **Pagination**: Configurable items per page.
- **Visual Indicators**: Status colors, note icons.
