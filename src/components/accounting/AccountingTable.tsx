...
export function AccountingTable({ orders, loading, pagination, onPageChange, onItemsPerPageChange, onEdit, onFilterChange }: AccountingTableProps) {
    ...
    // 5. Payment Filter (Has Payment / No Payment + Payment Date Range)
    ...
    // 6. Amount Filter (totalAmount range)
                                                ...
                                                <div className="flex gap-2">
                                                    <button
                                                        ...
                                                        className={`flex-1 py-1.5 text-xs rounded border transition-colors ${
                                                            filters.totalPaid?.[0] === "IS NOT NULL" ? "bg-primary text-primary-foreground border-primary" : "border-border hover:bg-muted"
                                                        }`}
                                                    >
                                                    ...
                                                    <button
                                                        onClick={handlePaymentFilterClick}
                                                        className={`flex-1 py-1.5 text-xs rounded border transition-colors ${
                                                            filters.totalPaid?.[0] === "IS NULL" ? "bg-primary text-primary-foreground border-primary" : "border-border hover:bg-muted"
                                                        }`}
                                                    >
                                            ...
                                            <div>
                                                ...
                                                <div className="flex gap-2">
                                                    <button
                                                        ...
                                                        className={`flex-1 py-1.5 text-xs rounded border transition-colors ${
                                                            filters.receiptId?.[0] === "IS NOT NULL" ? "bg-primary text-primary-foreground border-primary" : "border-border hover:bg-muted"
                                                        }`}
                                                    >
                                                    ...
                                                    <button
                                                        onClick={handleReceiptIdClick}
                                                        className={`flex-1 py-1.5 text-xs rounded border transition-colors ${
                                                            filters.receiptId?.[0] === "IS NULL" ? "bg-primary text-primary-foreground border-primary" : "border-border hover:bg-muted"
                                                        }`}
                                                    >
                                            ...
                                            <div className="relative group">
                                                <button
                                                    ...
                                                    className={`p-2 rounded-lg transition-colors ${
                                                        order.orderNote ? "bg-primary/10 text-primary hover:bg-primary/20" : "bg-muted text-muted-foreground hover:bg-muted/80"
                                                    }`}
                                                    title={t("order.note")}
                                                >
                                                    <StickyNote className="w-4 h-4" fill={order.orderNote ? "currentColor" : "none"} />
                                                </button>
                                                {/* Tooltip */}
                                                {order.orderNote && (
