export default {
  translation: {
    ...
    order: {
      ...
      searchPlaceholder:
        "Tìm kiếm theo mã đơn hàng, mã báo giá hoặc tên khách hàng...",
      ...
      quoteNote:
        "Để trống nếu đây là đơn hàng mới không xuất phát từ báo giá. Nhập mã và bấm 'Tải báo giá' để tự động điền thông tin.",
      ...
      print: {
        ...
        header: {
          lines: {
            ...
            line2:
              "Địa chỉ: 12 Phùng Khoang 2, P. Đại Mỗ, TP. Hà Nội - Điện thoại: 024 355 35 355 - Email: Cskh@irdop.org",
            line3: "",
          },
        },
        notePrefix: "Ghi chú:",
        ...
        disclaimer:
          "Thời gian thử nghiệm tính từ lúc Bên cung cấp dịch vụ nhận được mẫu kiểm nghiệm kèm hồ sơ Hợp lệ của Khách hàng và nhận được chi phí.",
        bankInfo: {
    ...
    quote: {
      ...
      print: {
        validityNote:
          "Báo giá có giá trị trong vòng 15 ngày kể từ ngày báo giá:",
        title: "BÁO GIÁ",
    ...
    accounting: {
      ...
      successMessage:
        "Hóa đơn cho đơn hàng {{orderId}} đã được tạo thành công!",
    },
